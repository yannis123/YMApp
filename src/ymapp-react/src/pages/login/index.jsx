...
import { setLoginUser, setAccessToken } from '@/commons';
    ...
    handleSubmit = (e) => {
        ...
        this.props.form.validateFields((err, values) => {
            if (!err) {
                ...
                this.props.ajax.post('/TokenAuth/Authenticate', params)
                    .then((res) => {
                        console.log(res);
                        if (res.success) {
                            // setLoginUser({
                            ...
                            //     name: 'Admin',
                            // });
                            const token = res.result.accessToken;//'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..b31f6RIdpRuv9Y8CneOuN2smbOeD5k1z8TUzBBB0msY';
                            console.log(token);
