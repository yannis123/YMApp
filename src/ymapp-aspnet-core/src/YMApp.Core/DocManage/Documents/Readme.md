...
<text name="FileSize"  value="FileSize"></text>
<text name="FilePath"  value="FilePath"></text>
...
<text name="OriName"  value="OriName"></text>
<text name="Category"  value="Category"></text>


<text name="Document" value=""></text><text name="QueryDocument"  value="查询"></text><text name="CreateDocument"  value="添加"></text><text name="EditDocument"  value="编辑"></text><text name="DeleteDocument"  value="删除"></text><text name="BatchDeleteDocument" value="批量删除"></text><text name="ExportDocument"  value="导出"></text>                             
