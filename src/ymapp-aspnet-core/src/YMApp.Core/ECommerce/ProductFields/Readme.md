...
```
Configuration.Authorization.Providers.Add<ProductFieldAuthorizationProvider>();
...
```
        ...
        {
            modelBuilder.ApplyConfiguration(new ProductFieldCfg());
        }
...
<text name="ProductType"  value="ProductType"></text>
...
<text name="ProductField" value=""></text><text name="QueryProductField"  value="查询"></text><text name="CreateProductField"  value="添加"></text><text name="EditProductField"  value="编辑"></text><text name="DeleteProductField"  value="删除"></text><text name="BatchDeleteProductField" value="批量删除"></text><text name="ExportProductField"  value="导出"></text>                             
