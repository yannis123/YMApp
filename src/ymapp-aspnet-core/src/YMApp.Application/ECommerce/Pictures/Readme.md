...
```
        ...
        {
            modelBuilder.ApplyConfiguration(new PictureCfg());
        }
...
<text name="Url"  value="Url"></text>
<text name="LinkUrl"  value="LinkUrl"></text>
...
<text name="Picture" value=""></text><text name="QueryPicture"  value="查询"></text><text name="CreatePicture"  value="添加"></text><text name="EditPicture"  value="编辑"></text><text name="DeletePicture"  value="删除"></text><text name="BatchDeletePicture" value="批量删除"></text><text name="ExportPicture"  value="导出"></text>                             
