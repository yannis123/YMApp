...
import { CreateOrUpdateProductInput,ProductEditDto, ProductServiceProxy } from '@shared/service-proxies/service-proxies';
...
@Component({
  ...
  styleUrls:[
	'create-or-edit-product.component.less'
  ],
})
  ...
  extends ModalComponentBase
    ...
    */
    submitForm(): void {
		...
		this._productService.createOrUpdate(input)
