...
```
        ...
        {
            modelBuilder.ApplyConfiguration(new TripCfg());
        }
...
<text name="PictureUrl"  value="PictureUrl"></text>
...
<text name="Trip" value=""></text><text name="QueryTrip"  value="查询"></text><text name="CreateTrip"  value="添加"></text><text name="EditTrip"  value="编辑"></text><text name="DeleteTrip"  value="删除"></text><text name="BatchDeleteTrip" value="批量删除"></text><text name="ExportTrip"  value="导出"></text>                             
