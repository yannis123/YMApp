...
{text:'Trip',i18n:'Trip',acl:'Pages.Trip',icon:'anticon anticon-dashboard',link:'/app/admin/trip'},
...
new MenuItem('Trip', 'Pages.Trip', 'anticon anticon-dashboard', '/app/admin/trip')

```

> '/app/admin/trip') 中的 admin 可以自行更改到你的特定模块下,
...
```
{  path: 'trip', component:TripComponent,data: { permission: 'Pages.Trip' }  },
